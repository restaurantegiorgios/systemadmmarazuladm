...
const translations = {
  'pt-BR': {
    ...
    'tour.buttons.back': 'Voltar',
    'tour.buttons.exit': 'Sair',
    'tour.buttons.finish': 'Finalizar',
    'tour.restart': 'Reiniciar Tour',
    'tour.dashboard.welcome': 'Bem-vindo ao Dashboard! Vamos fazer um tour rápido pelas principais funcionalidades.',
    'tour.dashboard.add': 'Clique aqui para adicionar um novo funcionário ao sistema.',
    'tour.dashboard.filters': 'Use estes controles para buscar, filtrar por cargo ou status.',
    'tour.dashboard.viewMode': 'Alterne entre a visualização em tabela ou em cards, como preferir.',
    'tour.dashboard.actions': 'Aqui você pode visualizar, editar ou deletar o perfil de um funcionário.',
    'tour.profile.welcome': 'Esta é a página de perfil do funcionário. Aqui você encontra todos os detalhes.',
    'tour.profile.edit': 'Use este botão para entrar no modo de edição e atualizar as informações.',
    'tour.profile.tabs': 'Navegue entre os detalhes pessoais e os documentos do funcionário.',
    'tour.profile.print': 'Clique aqui para gerar uma versão para impressão do perfil completo.',
    'tour.receipts.welcome': 'Bem-vindo ao Gerador de Recibos! Crie recibos de forma rápida e fácil.',
    'tour.receipts.form': 'Preencha as informações do recibo neste formulário.',
    'tour.receipts.generate': 'Após preencher, clique aqui para gerar uma pré-visualização do recibo.',
    'tour.receipts.preview': 'A pré-visualização do seu recibo aparecerá aqui.',
    'tour.receipts.print': 'Quando estiver tudo certo, use este botão para imprimir o recibo.',
  },
  'en-US': {
    // Header
    'language': 'Language',
    ...
    'tour.buttons.exit': 'Exit',
    'tour.buttons.finish': 'Finish',
    'tour.restart': 'Restart Tour',
    'tour.dashboard.welcome': 'Welcome to the Dashboard! Let\'s take a quick tour of the main features.',
    'tour.dashboard.add': 'Click here to add a new employee to the system.',
    'tour.dashboard.filters': 'Use these controls to search, filter by position or status.',
    'tour.dashboard.viewMode': 'Switch between table or card view as you prefer.',
    'tour.dashboard.actions': 'Here you can view, edit, or delete an employee\'s profile.',
    'tour.profile.welcome': 'This is the employee profile page. Here you can find all the details.',
    'tour.profile.edit': 'Use this button to enter edit mode and update information.',
    'tour.profile.tabs': 'Navigate between personal details and employee documents.',
    'tour.profile.print': 'Click here to generate a printable version of the full profile.',
    'tour.receipts.welcome': 'Welcome to the Receipt Generator! Create receipts quickly and easily.',
    'tour.receipts.form': 'Fill in the receipt information in this form.',
    'tour.receipts.generate': 'After filling it out, click here to generate a preview of the receipt.',
    'tour.receipts.preview': 'The preview of your receipt will appear here.',
    'tour.receipts.print': 'When everything is correct, use this button to print the receipt.',
  },
};
